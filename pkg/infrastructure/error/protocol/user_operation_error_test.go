...
func TestUserOperationError(t *testing.T) {
	const detail = "detail"
	...
	testError := NewUserOperationError(ErrorCode(codeName), description)
	...
	parsedError := "{\"id\":\"1f38b18b-2606-49dc-99b0-ed187e0a2618\",\"errorCode\":\"TestService.User.USER_ALREADY_EXIST\",\"description\":\"describing current error\",\"details\":[\"detail\"],\"type\":\"UserOperation\"}"
